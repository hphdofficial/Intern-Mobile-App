...
public class OrderStatusModel {
    ...
    public static class DetailCart {
        ...
        public static class Product {
            ...
            public void setUnitsInStock(int unitsInStock) { UnitsInStock = unitsInStock; }

            public String getCategoryName() { return CategoryName; }
            public void setCategoryName(String categoryName) { CategoryName = categoryName; }

            public String getLink_image() { return link_image; }
            public void setLink_image(String link_image) { this.link_image = link_image; }
    ...
    public String getTxn_ref() { return txn_ref; }
    public void setTxn_ref(String txn_ref) { this.txn_ref = txn_ref; }

    public double getAmount() { return amount; }
    public void setAmount(double amount) { this.amount = amount; }

    public String getOrder_info() { return order_info; }
    public void setOrder_info(String order_info) { this.order_info = order_info; }
    ...
    public String getGiao_hang() { return giao_hang; }
    public void setGiao_hang(String giao_hang) { this.giao_hang = giao_hang; }

    public List<DetailCart> getDetail_carts() { return detail_carts; }
    public void setDetail_carts(List<DetailCart> detail_carts) { this.detail_carts = detail_carts; }
}
