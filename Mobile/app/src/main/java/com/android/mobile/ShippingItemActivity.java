...
public class ShippingItemActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        EdgeToEdge.enable(this);
        setContentView(R.layout.activity_shipping_item);
        ...
        ShippingItemAdapter shippingItemAdapter = new ShippingItemAdapter(this, data);
